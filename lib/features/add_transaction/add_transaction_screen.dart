...
class _AddTransactionScreenState extends ConsumerState<AddTransactionScreen> {
  ...
  void initState() {
    ...
    if (_isEditing) {
      ...
      if (widget.initialAmount != null) {
        _amountController.text = _bufferFromMoney(widget.initialAmount!);
      }
  ...
  Future<void> _loadForEdit() async {
    ...
    setState(() {
      _type = row.type;
      _amountController.text = _bufferFromMoney(row.amount);
          ...
          children: [
            Row(
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    if (mode == _SplitMode.categories) {
                      _setSplitMode(_SplitMode.accounts);
                    } else {
                      _setSplitMode(_SplitMode.categories);
                    }
                  },
                  ...
                  child: _SplitModeKnob(mode: mode),
                ),
                Expanded(
                  child: _splitModeLabel(
                    theme,
                    ...
                    Padding(
                      ...
                      child: FittedBox(
                        ...
                        child: Row(
                          ...
                          children: [
                          Text(
                            txCurrency == null ? MoneyFormat.inputPrefix.trim() : txCurrency.symbol,
                            style: theme.textTheme.displayMedium?.copyWith(
                              fontWeight: FontWeight.w700,
                              color: colorForTxType(_type).withValues(alpha: 0.5),
                            ),
                          ),
