...
| Unique application id | ✅ `com.codeshowoff.xpenc` |
...
| Build recipe (draft) | [`metadata-com.codeshowoff.xpenc.yml`](metadata-com.codeshowoff.xpenc.yml) | copied into the **fdroiddata** repo, not this one |
...
[`metadata-com.codeshowoff.xpenc.yml`](metadata-com.codeshowoff.xpenc.yml) for the pattern
...
2. Fork [fdroiddata](https://gitlab.com/fdroid/fdroiddata), branch `com.codeshowoff.xpenc`.
3. Copy [`metadata-com.codeshowoff.xpenc.yml`](metadata-com.codeshowoff.xpenc.yml) to
   `metadata/com.codeshowoff.xpenc.yml` in the fork; **delete the header comments**.
