...
OPEN SOURCE
XPENC is open source under the MIT license. You can read every line of code, verify the privacy claims yourself, and contribute at github.com/CodeShowOff/XPENC
```
